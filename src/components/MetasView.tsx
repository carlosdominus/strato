                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-baseline justify-between pt-1">
                      ...
                      <div className="text-right">
                        <span className="text-[10px] font-bold text-[#11310C]/50 uppercase block">Meta</span>
                        <span className="text-sm font-bold text-[#11310C]/80">{formatCurrency(goal.targetAmount)}</span>
                      </div>
                    </div>
            ...
            <form onSubmit={handleCreateGoal} className="space-y-3 text-xs font-semibold text-[#11310C]">
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="Ex: Comprar Casa Própria, Viagem Japão"
                  value={title}
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <label className="block mb-1">Valor Já Salvo (R$)</label>
                  <input
                    type="number"
                    placeholder="15000"
                    value={currentAmount}
              ...
              <div>
                ...
                >
                  ...
                  <option value="imovel">Imóvel / Casa Própria</option>
                  <option value="aposentadoria">Aposentadoria / Renda Passiva</option>
